...
namespace LivingArrangement_TTSML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\gonza\Desktop\TMG\GitHub\TMG_PORPOS\Data\SMTO_2015_ML_Format.csv";
        private static string MODEL_FILEPATH = @"C:\Users\gonza\AppData\Local\Temp\MLVSTools\LivingArrangement_TTSML\LivingArrangement_TTSML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Concatenate("Features", new[] { "Home Zone", "Cars", "Children", "Adults", "Income", "Gender", "Age", "Status", "License", "Distance", "Employment", "Mode" });
            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.LightGbm(labelColumnName: "Family?", featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "Family?");
