...
dist_model = mlogit(School ~ Dist + Family:Dist + IsClosest + log(Total) | 0, data=mldf, reflevel="SG")
access_model = mlogit(School ~ Access + Family:Dist + IsClosest + log(Total) | 0, data=mldf, reflevel="SG")
combined_model = mlogit(School ~ Dist + Access + Family:Dist + IsClosest + log(Total) | 0, data=mldf, reflevel="SG")
