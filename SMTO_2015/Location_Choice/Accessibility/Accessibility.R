...
# Load Data ----
setwd("C:/Users/ethan/Documents/Ethan/TMG/Research/PORPOS-TMG/SMTO_2015/Accessibility")
...
dist_model = mlogit(School ~ Dist + log(Total) + Family:Dist + IsClosest | 0, data=mldf)
access_model = mlogit(School ~ Access + log(Total) + Family:Dist + IsClosest | 0, data=mldf)
get_log_lik(dist_model)
get_softmax_accuracy(dist_model)
get_log_lik(access_model)
