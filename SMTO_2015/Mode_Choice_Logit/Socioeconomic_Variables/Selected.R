...
library(mlogit)
library(data.table)
setwd("C:/Users/ethan/Documents/Ethan/TMG/Research/PORPOS-TMG/SMTO_2015/Mode_Choice_Logit/Socioeconomic_Variables")
source("../../../Metrics.R")
...
# Mode Choice Data ----
df = df[c('Mode', 'Licence', 'Family', 'Time.Auto', 'Time.Transit', 'Time.Active')]
mldf = mlogit.data(df, varying = 4:6, choice = "Mode", shape = "wide")

# Mode Choice Model ----
model = mlogit(Mode ~ 0 | Family + Licence | Time, data=mldf, reflevel="Transit")
summary(model)
