...
#                 c(mFormula(School_Codes ~ Dist | Mode), 1),
#                 c(mFormula(School_Codes ~ Dist | Licence + Cars), 2),
#                 c(mFormula(School_Codes ~ Dist | Licence + Mode), 2),
#                 c(mFormula(School_Codes ~ Dist | Cars + Mode), 2),
#                 c(mFormula(School_Codes ~ Dist | Licence + Cars + Mode), 3),
#                 c(mFormula(School_Codes ~ Dist | Income), 1),
#                 c(mFormula(School_Codes ~ Dist | Income + Mode), 2),
#                 c(mFormula(School_Codes ~ Dist | Income + Cars), 2),
#                 c(mFormula(School_Codes ~ Dist | Income + Cars + Mode), 3),
#                 c(mFormula(School_Codes ~ Dist | Income + Cars + Licence + Mode), 4),
#                 c(mFormula(School_Codes ~ Dist | Income + Children), 2),
#                 c(mFormula(School_Codes ~ Dist | Income + Children + Adults), 3),
#                 c(mFormula(School_Codes ~ Dist | Income + Cars + Licence + Mode + Children + Adults), 6))

formulas = list(c(mFormula(School_Codes ~ Dist | Cars + Family + Level), 1))
